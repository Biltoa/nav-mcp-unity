...
//     unity/com.umcp.agent/Editor/Tools/. Do not edit by hand — edit the tool and
...
namespace Umcp.Agent
{
    internal static class ToolDispatch
    {
        ...
        static readonly Dictionary<string, ToolMeta> _meta = new Dictionary<string, ToolMeta>
        {
            ...
            { "compile.errors", new ToolMeta { Id = "compile.errors", Skill = "compile", Summary = "Structured compile errors and warnings: file, line, column, message.", Mutating = false, Retry = "Read", Cost = "Cheap", Undo = null, NoUndoReason = null } },
            ...
            { "console.clear", new ToolMeta { Id = "console.clear", Skill = "console", Summary = "Clear the captured console buffer and Unity's console window.", Mutating = true, Retry = "None", Cost = "Cheap", Undo = null, NoUndoReason = "Log output is not object state." } },
            { "console.read", new ToolMeta { Id = "console.read", Skill = "console", Summary = "Read captured console messages. Bounded, newest last.", Mutating = false, Retry = "Read", Cost = "Cheap", Undo = null, NoUndoReason = null } },
            { "editor.compile", new ToolMeta { Id = "editor.compile", Skill = "editor", Summary = "Request a script recompilation. Triggers a domain reload.", Mutating = true, Retry = "Compile", Cost = "Expensive", Undo = null, NoUndoReason = "Compilation is not an undoable operation." } },
            { "editor.ping", new ToolMeta { Id = "editor.ping", Skill = "editor", Summary = "Round-trip liveness probe. Executes on the Editor main thread.", Mutating = false, Retry = "Read", Cost = "Cheap", Undo = null, NoUndoReason = null } },
            { "editor.selection.get", new ToolMeta { Id = "editor.selection.get", Skill = "editor", Summary = "Read the current Editor selection.", Mutating = false, Retry = "Read", Cost = "Cheap", Undo = null, NoUndoReason = null } },
            { "editor.selection.set", new ToolMeta { Id = "editor.selection.set", Skill = "editor", Summary = "Set the Editor selection.", Mutating = true, Retry = "Write", Cost = "Cheap", Undo = null, NoUndoReason = "Selection is editor UI state, not object state." } },
            { "editor.stall", new ToolMeta { Id = "editor.stall", Skill = "editor", Summary = "Diagnostic: block the Editor main thread for N seconds, reproducing a modal dialog's effect.", Mutating = false, Retry = "None", Cost = "Expensive", Undo = null, NoUndoReason = "A diagnostic stall changes no state." } },
            { "editor.status", new ToolMeta { Id = "editor.status", Skill = "editor", Summary = "Editor state: compiling, updating, play mode, focus, selection.", Mutating = false, Retry = "Read", Cost = "Cheap", Undo = null, NoUndoReason = null } },
            ...
            { "prefab.create", new ToolMeta { Id = "prefab.create", Skill = "prefab", Summary = "Save a scene GameObject as a prefab asset.", Mutating = true, Retry = "Write", Cost = "Cheap", Undo = "Create Prefab", NoUndoReason = null } },
            { "prefab.instantiate", new ToolMeta { Id = "prefab.instantiate", Skill = "prefab", Summary = "Instantiate a prefab into the active scene.", Mutating = true, Retry = "Write", Cost = "Cheap", Undo = "Instantiate Prefab", NoUndoReason = null } },
            { "project.info", new ToolMeta { Id = "project.info", Skill = "project", Summary = "Project identity: name, path, Unity version, pipeline, package count.", Mutating = false, Retry = "Read", Cost = "Cheap", Undo = null, NoUndoReason = null } },
